...
const SignupForm = ({setIsLoggedIn}) => {
    ...
    return (
        <div>
            <div className='bg-richblack-800 p-1 gap-x-1 my-6 flex  rounded-full max-w-max '>
            ...
            <form onSubmit={submitHandler}>
                ...
                <button className='w-full bg-yellow-50 font-medium text-richblack-900 px-[12] py-[8px] rounded-[8px] mt-6'>Create Account</button>
            </form>
        </div>
    )
}
